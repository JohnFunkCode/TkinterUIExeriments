...
import TkinterMVCExperiments.GUI.datavalidation.data_validation_view

class DataValidationController():
    def __init__(self, app_container: ttk.Frame):
        super().__init__()
        self.app_container = app_container
        self.data_validation_view = TkinterMVCExperiments.GUI.datavalidation.data_validation_view.DataValidationView(app_container,self)
